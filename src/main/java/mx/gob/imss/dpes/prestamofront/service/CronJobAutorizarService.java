 ...
 */
@Provider
public class CronJobAutorizarService extends ServiceDefinition<RequestPrestamo, RequestPrestamo> {
    ...
    public Message<RequestPrestamo> execute(Message<RequestPrestamo> request) throws BusinessException {
        log.log(Level.INFO, "########## Step 6 ##########");
        log.log(Level.INFO, "########## prestamoFront CronJobAutorizarService ##########");
//        log.log(Level.INFO, ">>>prestamoFront CronJobAutorizarService request.getPayload()= {0}", request.getPayload());
            ...
            log.log(Level.INFO, "########## Ejecutando CronTareaClient (http://localhost/bitacoraFront/webresources/) ##########");
            ...
            if (load.getStatus() == 200) {
                        ...
                        log.log(Level.INFO, "   >>><<<CronJobAutorizarService cronTareaResponse= {0}", cronTareaResponse);
